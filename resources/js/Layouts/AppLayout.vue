                                ...
                                <Dropdown align="right" width="48">
                                    <template #trigger>
                                        ...
                                        "
                                            ...
                                            <img class="object-cover rounded-full size-8" :src="$page.props.auth.user
                                                .profile_photo_url
                ...
                <div :class="{
                    ...
                    <div v-if="$page.props.auth.user" class="pt-4 pb-1 border-t border-gray-200">
                        <div class="flex items-center px-4">
                            ...
                            " class="shrink-0 me-3">
                                <img class="object-cover rounded-full size-10" :src="$page.props.auth.user.profile_photo_url
                                    " :alt="$page.props.auth.user.name" />
                            </div>
